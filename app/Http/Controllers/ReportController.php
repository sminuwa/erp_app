    ...
    public function loadDocumentStatus(Request $request)
    {
        ...
        if ($type == "Invoice")
            $query = Order::where('branch_id', 'LIKE', $branch_id)
                ...
                ->where('branches.company_id', 'LIKE', $company_id)
                ->where('orders.status', '=', $status)->orderBy('order_date', "DESC")
        ...
        if ($type == "Payment")
            $query = Payment::where('branch_id', 'LIKE', $branch_id)
                ...
                ->where('branches.company_id', 'LIKE', $company_id)
                ->where('payments.status', '=', $status)->orderBy('date', "DESC")
                ->whereDate('date', '>=', $from_date)
                ->whereDate('date', '<=', $to_date);
        if ($type == "Receipt")
            $query = Receipt::where('branch_id', 'LIKE', $branch_id)
                ...
                ->where('branches.company_id', 'LIKE', $company_id)
                ->where('receipts.status', '=', $status)->orderBy('date', "DESC")
                ->whereDate('date', '>=', $from_date)
                ->whereDate('date', '<=', $to_date);
        if ($type == "Journal")
            $query = Journal::where('branch_id', 'LIKE', $branch_id)
                ...
                ->where('branches.company_id', 'LIKE', $company_id)
                ->where('journals.status', '=', $status)->orderBy('date', "DESC")
                ->whereDate('date', '>=', $from_date)
                ->whereDate('date', '<=', $to_date);
        if ($type == "Interbank")
            $query = InterBank::where('branch_id', 'LIKE', $branch_id)
                ...
                ->where('branches.company_id', 'LIKE', $company_id)
                ->where('inter_banks.status', '=', $status)->orderBy('date', "DESC")
                ->whereDate('date', '>=', $from_date)
                ->whereDate('date', '<=', $to_date);

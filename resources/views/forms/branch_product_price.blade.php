<form action="{{ isset($route) ? $route : route('branch_product_prices.store') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" class="form-control {{ $errors->has('retail_selling_price') ? ' is-invalid' : '' }}" step=".01"
    ...
    <div class="form-group">
        ...
        <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" class="form-control {{ $errors->has('whole_selling_price') ? ' is-invalid' : '' }}" step=".01"

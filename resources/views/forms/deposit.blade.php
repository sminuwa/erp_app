<form action="{{ isset($route) ? $route : route('deposits.store') }}" method="POST">
    {{ csrf_field() }}
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <i class="ion-android-send"></i> Deposit Panel
                </div>
                <div class="card-body table-responsive">
                    ...
                    <div class="row">
                        ...
                        {{--<div class="col-md-6">
                            <div class="form-group">
                                <label for="deposited_by">Deposit By</label>
                                <select
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="slip_no">Deposit Slip No</label>
                        ...
                        <div class="col-md-6">
                            <div class="col-sm-6 text-danger">
                                    <strong>Total Record is of {{number_format(App\Models\CashMovement::count('*'),0,',','')}}</strong>
                            </div>

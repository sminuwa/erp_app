                                                ...
                                                <div class="col-12">
                                                    <div class="form-group" wire:ignore>
                                                        <select wire:model="type.{{ $key }}"
                                                            wire:change.lazy="changeTypeEvent($event.target.value, {{ $key }})"
                                            ...
                                            <td>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="floating-label">Account: @error('account.' . $key)
                                                                <span class="text-danger error">{{ $message }}</span>
                                                            @enderror
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group" wire:ignore>
                                                        <input type="number" min="0" step=".01"
                                                            ...
                                                            wire:model.lazy="debit.{{ $key }}"
                                                            wire:change="totals">
                                                        <label class="floating-label">Debit: @error('debit.' . $key)
                                                                <br><span
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group" wire:ignore>
                                                        <input type="number" min="0" step=".01"
                                                            ...
                                                            wire:model.lazy="credit.{{ $key }}"
                                                            wire:change="totals">
                                                        <label class="floating-label">Credit: @error('credit.' . $key)
                                                                <br><span
                                                                    class="text-danger error">{{ $message }}</span>
                                                            @enderror
                                                        </label>
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group mb-3" wire:ignore>
                                                        <input type="text" class="form-control"
                                                            placeholder="Description"
                                                            wire:model.lazy="desc.{{ $key }}">
                                                        <label class="floating-label">Description: @error('desc.' .
                                                                $key)
                                                                <br><span
                                                                    class="text-danger error">{{ $message }}</span>
                                                            @enderror

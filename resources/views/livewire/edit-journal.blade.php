                                    ...
                                    @foreach($inputs as $key => $value)
                                        <tr :wire:key="{{ $loop->index }}" wire:ignore.self>
                                            ...
                                            <td>
                                                <div class="col-12">
                                                    <div class="form-group" wire:ignore>
                                                        <input type="number" min="0" class="form-control" step=".01" placeholder="Debit" wire:model.lazy="debit.{{ $key }}" wire:keyup="totals">
                                            ...
                                            <td>
                                                <div class="col-12">
                                                    <div class="form-group" wire:ignore>
                                                        <input type="number" min="0" class="form-control" step=".01" placeholder="Credit" wire:model.lazy="credit.{{ $key }}" wire:keyup="totals">

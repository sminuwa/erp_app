                    ...
                    <td align="center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="{{ route('journal.show', $record->id) }}" class="dropdown-item">
                                    <i class="fa fa-eye" aria-hidden="true"></i> Open
                                </a>
                                <a href="{{ route('journal.print', [$record->id, 'A4']) }}" target="_blank"
                                    class="dropdown-item">
                                    <i class="fa fa-print" aria-hidden="true"></i> Print A4
                                </a>
                                <a href="{{ route('journal.print', [$record->id, 'A5']) }}" target="_blank"
                                    class="dropdown-item">
                                ...
                                @if ($record->status == 0)
                                    ...
                                    @endcan
                                    <a href="{{ route('journal.edit', $record->id) }}" class="dropdown-item">

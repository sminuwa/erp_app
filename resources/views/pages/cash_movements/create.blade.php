...
@section('title', 'Deposit and Withdrawal')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4>Bank Deposit and Withdrawal</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li class="breadcrumb-item active">Deposit and Withdrawal</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            style="margin-left: 2px;"><span class="ion-model-s"> </span> New Withdraw</a>
            <div class="container-fluid">
                <div class="row">
                    <div class='col-md-12'>
                        @include('forms.cash_movement')
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
    ...
    <script type="text/javascript">
        ...
        $('#from_account').on("change", function() {
            ...
            $.ajax({
                ...
                $("#from_balance").val(formatMoney(data));
            });
        });
        $('#to_account').on("change", function() {
            bank_account_id = $(this).val();
            $.ajax({
                ...
                $("#to_balance").val(formatMoney(data));
            });
        });

    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Bank Withdraw & Deposit</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Bank Withdrw & Deposit</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <a class="btn btn-secondary btn-sm" href="{{ route('cash_movements.create') }}">
                        ...
                        <div class='card'>
                            ...
                            <div class="card-body">
                                @include('forms.cash_movement', [
                                    'route' => route('cash_movements.update', $model->id),
                                    'method' => 'PUT',
                                ])
                            </div>
                        </div>

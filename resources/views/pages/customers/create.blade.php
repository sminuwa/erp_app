                            ...
                            <div class="card-body">
                                <form action="{{ isset($route) ? $route : route('customers.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            class="form-control ajax-branches {{ $errors->has('branch_id') ? ' is-invalid' : '' }}"
                                            name="branch_id" id="branch_id" selected_item="{{ $model->branch_id }}"
                                            required></select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="R" {{ old('account_type', $model->account_type) }}
                                                {{ $model->type == 'Retail' ? 'selected' : '' }}>Retail</option>
                                            <option value="W" {{ old('account_type', $model->account_type) }}
                                                {{ $model->type == 'Wholesale' ? 'selected' : '' }}>Wholesale</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email"
                                            ...
                                            name="email" id="email" value="{{ old('email', $model->email) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="gender" name="gender" class="form-control" required>
                                            ...
                                            <option value="Male"
                                                {{ old('gender') == 'Male' || (isset($customer) && $customer->gender == 'Male') ? 'selected' : '' }}>
                                                Male</option>
                                            <option value="Female"
                                                {{ old('gender') == 'Female' || (isset($customer) && $customer->gender == 'Female') ? 'selected' : '' }}>
                                                Female</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="business_type" name="business_type" class="form-control" required>
                                            ...
                                            <option value="Sole Proprietorship"
                                                {{ old('business_type') == 'Sole Proprietorship' || (isset($customer) && $customer->business_type == 'Sole Proprietorship') ? 'selected' : '' }}>
                                                Sole Proprietorship</option>
                                            <option value="Partnership"
                                                {{ old('business_type') == 'Partnership' || (isset($customer) && $customer->business_type == 'Partnership') ? 'selected' : '' }}>
                                                Partnership</option>
                                            <option value="Limited Liability"
                                                {{ old('business_type') == 'Limited Liability' || (isset($customer) && $customer->business_type == 'Limited Liability') ? 'selected' : '' }}>
                                                Limited Liability</option>
                                            <option value="Corporation"
                                                {{ old('business_type') == 'Corporation' || (isset($customer) && $customer->business_type == 'Corporation') ? 'selected' : '' }}>
                                                Corporation</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="business_age" name="business_age" class="form-control" required>
                                            ...
                                            <option value="<1 year"
                                                {{ old('business_age') == '<1 year' || (isset($customer) && $customer->business_age == '<1 year') ? 'selected' : '' }}>
                                                <1 year</option>
                                            <option value="1-3 years"
                                                {{ old('business_age') == '1-3 years' || (isset($customer) && $customer->business_age == '1-3 years') ? 'selected' : '' }}>
                                                1-3 years</option>
                                            <option value="3-5 years"
                                                {{ old('business_age') == '3-5 years' || (isset($customer) && $customer->business_age == '3-5 years') ? 'selected' : '' }}>
                                                3-5 years</option>
                                            <option value="5+ years"
                                                {{ old('business_age') == '5+ years' || (isset($customer) && $customer->business_age == '5+ years') ? 'selected' : '' }}>
                                                5+ years</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="address" id="address" value="{{ old('address', $model->address) }}"
                                            placeholder="" maxlength="191" required="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('credit_limit', $model->credit_limit) }}" placeholder=""
                                            value="0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control {{ $errors->has('status') ? ' is-invalid' : '' }}"
                                            ...
                                            <option value="1" @if ($model->status == 1) selected @endif>Active
                                            </option>
                                            <option value="0" @if ($model->status == 0) selected @endif>
                                                Inactive
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            name="relation_officer" id="relation_officer" required>
                                            @foreach ($officers as $officer)
                                                <option value="{{ $officer->id }}"
                                                    {{ $model->relation_officer == $officer->id ? 'selected' : '' }}>
                                                    {{ $officer->user_code }} - {{ $officer->name }}</option>
                                            @endforeach
                                        </select>

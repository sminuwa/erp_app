            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('expenses.search') }}" method="POST">
                            ...
                            <div class="input-group">
                                <input type="search" class="form-control rounded" required placeholder="Search by Impress number"
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        @include('tables.expense')
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 text-danger">
                        <strong>Total Record is of
                            {{ number_format(App\Models\Expense::groupBy('impress')->count('*'), 0, ',', '') }}</strong>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>

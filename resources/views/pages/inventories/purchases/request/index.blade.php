                                    ...
                                    <tbody>
                                        @foreach ($records as $record)
                                            <tr class="@if ($record->status == 0) bg-warning @endif">
                                                ...
                                                <td> {{ $record->status == 0 ? 'Open' : ($record->status == 1 ? 'Completed' : 'Closed') }}
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            @can('purchases.request.show')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('purchases.request.show', $record->id) }}">
                                                                    <span class="fa fa-eye"> View</span>
                                                                </a>
                                                            @endcan
                                                            @if ($record->status == 0)
                                                                @can('purchases.request.close')
                                                                    <form
                                                                        action="{{ route('purchase.request.close', $record->id) }}"
                                                                        method="post"
                                                                ...
                                                                @endcan
                                                                @can('purchases.request.link')
                                                                    <form
                                                                        action="{{ route('purchase.request.link', $record->id) }}"
                                                                        method="post"
                                                                ...
                                                                @can('purchases.request.edit')
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('purchases.request.edit', $record->id) }}">
                                                            ...
                                                            @can('purchases.request.destroy')
                                                                <form
                                                                    ...
                                                                    action="{{ route('purchases.request.destroy', $record->id) }}"
                                            ...
                                            <div class="modal fade" id="customermodal{{ $loop->index + 1 }}"

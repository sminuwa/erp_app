                                ...
                                <table id="example1"
                                    ...
                                    @foreach ($journals as $journal)
                                        <tr>
                                            ...
                                            <td>{{ Carbon\Carbon::parse($journal->date)->toFormattedDateString() }}
                                            </td>
                                            <td>{{ $journal->receipt_no }}</td>
                                            <td align="right">{{ number_format($journal->amount, 2, '.', ',') }}</td>
                                            <td>{{ $journal->description }}</td>
                                            <td>{{ $journal->source->description }}</td>
                                            <td>{{ $journal->destination->description }}</td>
                                            <td>{{ optional($journal->transfered_by)->name }}</td>
                                            <td align="center">
                                                ...
                                                <a href="javascript:void(0)" data-toggle="modal"
                                                   data-target="#payment_edit{{ $journal->id }}"
                                                   data-val="{{ $journal->id }}" class="btn btn-primary btn-sm edit">

...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ route('loan_collectors.search') }}" method="POST">
                        @csrf
                        <div class="input-group">
                            <input type="search" class="form-control rounded" required
                                placeholder="Search by Reg code, phone, or email" name="refno" aria-label="Search"

...
<head>
    <meta charset="utf-8">
    <title>Batch Production - {{ $record->reference }}</title>
    <style>
...
<body>
    ...
    <table class="info-table">
        <tr>
            ...
            <td>{{ $record->production_date ? date('d-M-Y', strtotime($record->production_date)) : '-' }}</td>
        ...
        <tr>
            ...
            <td class="label">Quantity (Batches):</td>

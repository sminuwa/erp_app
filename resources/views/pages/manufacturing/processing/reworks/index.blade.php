...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <a class="btn btn-primary btn-sm mb-3" href="{{ route('manufacturing.reworks.create') }}">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Manufacturing Reworks List</h3>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('manufacturing.reworks.show', $record->id) }}" class="btn btn-info btn-xs" title="View">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    @endcan
                                    ...
                                    <form action="{{ route('manufacturing.reworks.destroy', $record->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this rework?')" title="Delete">

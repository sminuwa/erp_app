            ...
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity" id="quantity" class="form-control" step="0.0001" min="0" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="labor_cost" class="form-control cost-input" step="0.01" min="0" value="0">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Power Cost</label>
                                    <input type="number" name="power_cost" class="form-control cost-input" step="0.01" min="0" value="0">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Other Cost</label>
                                    <input type="number" name="other_cost" class="form-control cost-input" step="0.01" min="0" value="0">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">Save Manufacturing</button>

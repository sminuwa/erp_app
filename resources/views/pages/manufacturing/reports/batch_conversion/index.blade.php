...
@section('title', 'Batch Conversion Report')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Batch Conversion</li>
                    </ol>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#load-report').click(function() {
        ...
        $.ajax({
            url: '{{ route("manufacturing.reports.batch_conversion.load") }}',
            type: 'GET',
            data: form.serialize(),

...
@section('title', 'Production Orders Report')
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Production Orders Report</h4>
                </div>
                <div class="col-sm-6">
...
$(document).ready(function() {
    ...
    $('#load-report').click(function() {
        ...
        $.ajax({
            url: '{{ route("manufacturing.reports.orders.load") }}',
            type: 'GET',
            data: form.serialize(),
    ...
    $('#print-report').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.orders.print") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-pdf').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.orders.export_pdf") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-excel').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.orders.export_excel") }}?' + form.serialize();
        window.open(url, '_blank');
    });
});
</script>

...
@section('title', 'Materials Requisitions Report')
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Materials Requisitions Report</h4>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="bom_type" id="bom_type" class="form-control select2-single">
                                        <option value="">All Types</option>
                                        <option value="single">Single Product</option>
                                        <option value="batch">Batch Manufacturing</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2">
...
$(document).ready(function() {
    ...
    $('#load-report').click(function() {
        ...
        $.ajax({
            url: '{{ route("manufacturing.reports.requisitions.load") }}',
            type: 'GET',
            data: form.serialize(),
    ...
    $('#print-report').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.requisitions.print") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-pdf').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.requisitions.export_pdf") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-excel').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.requisitions.export_excel") }}?' + form.serialize();
        window.open(url, '_blank');
    });
});
</script>

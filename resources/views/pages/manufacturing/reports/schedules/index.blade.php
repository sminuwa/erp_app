...
@section('title', 'Daily Schedules Report')
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Daily Manufacturing Schedules Report</h4>
                </div>
                <div class="col-sm-6">
                    ...
                    <form id="report-form">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Machine</label>
                                    <select name="machine_id" id="machine_id" class="form-control select2-single">
...
$(document).ready(function() {
    ...
    $('#load-report').click(function() {
        ...
        $.ajax({
            url: '{{ route("manufacturing.reports.schedules.load") }}',
            type: 'GET',
            data: form.serialize(),
    ...
    $('#print-report').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.schedules.print") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-pdf').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.schedules.export_pdf") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-excel').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.schedules.export_excel") }}?' + form.serialize();
        window.open(url, '_blank');
    });
});
</script>

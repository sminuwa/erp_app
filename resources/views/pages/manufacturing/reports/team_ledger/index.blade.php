...
@section('title', 'Team & Staff Ledger Report')
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Team & Staff Ledger Report</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Team & Staff Ledger</li>
                    </ol>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#load-report').click(function() {
        ...
        $.ajax({
            url: '{{ route("manufacturing.reports.team_ledger.load") }}',
            type: 'GET',
            data: form.serialize(),
    ...
    $('#print-report').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.team_ledger.print") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-pdf').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.team_ledger.export_pdf") }}?' + form.serialize();
        window.open(url, '_blank');
    });

    $('#export-excel').click(function() {
        var form = $('#report-form');
        var url = '{{ route("manufacturing.reports.team_ledger.export_excel") }}?' + form.serialize();
        window.open(url, '_blank');
    });
});
</script>

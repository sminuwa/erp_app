        ...
        <form action="{{ route('orders.update', $item->id) }}" method="post">
            ...
            <div class="row">
                <div class="form-group col-sm-2 mb-2">
                    ...
                    <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" class="form-control form-control-sm" value="{{ $item->quantity }}" name="qty"
                        id="qty{{ $item->id }}">
                </div>
                ...
                <div class="form-group col-sm-2 mb-2">
                    ...
                    <input type="number" step=".01" class="form-control form-control-sm" name="new_cost"
                        id="unit_cost{{ $item->id }}" value="{{ $item->unit_cost }}">
                </div>
                <div class="form-group col-sm-2 mb-2">
                    <label for="unit_cost" class="col-sm-2 col-form-label">Total</label>
                    <input type="number" step=".01" class="form-control form-control-sm" readonly name="total"
                        value="{{ $item->total }}" />
                </div>
                <div class="form-group col-sm-2 mb-2">
                    <br />

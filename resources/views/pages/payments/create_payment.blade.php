                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2-single {{ $errors->has('type') ? ' is-invalid' : '' }}"
                                            ...
                                            <option value="Supplier" {{ 'Supplier' == $model->model_name ? 'selected' : '' }}>Supplier
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="payment_ref" id="payment_ref">@if(isset($model)) {{ $model->description }} @endif</textarea>

        ...
        <section class="content">
            <div class="container">
                @can('order.invoice.list')
                    <a href="{{ route('order.invoice.list') }}" class="btn btn-sm btn-secondary"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="account_type" id="account_type" class="form-control"
                                                    ...
                                                    <option value="Retail"
                                                            @if (session()->has('customer') && session('customer')->type == 'Retail') selected @endif
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="submit" id="create_invoice"
                                                        class="btn btn-sm btn-info float-md-right ml-3">Create Invoice
                                                </button>
                                            </div>
                                        </div>
                                    </div>

                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Whole Sale Point</h3>
                                                ...
                                                <tr>
                                                    ...
                                                    <form action="{{ route('cart.update') }}" method="post"
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                <input type="text" name="sold_price" readonly
                                                                    id="price{{ $product->id }}" class="form-control price"
                                                        ...
                                                        <input type="hidden" name="cost_price" id="cp{{ $product->id }}" class="form-control"

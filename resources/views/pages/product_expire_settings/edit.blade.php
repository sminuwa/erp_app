...
@section('title', 'Products Expiration Settings')
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1>Edit Product expiration setting: <small>{{$model->product->name}}</small></h1>
					</div>
					<div class="col-sm-6">
                        ...
                        <div class='card'>
                            ...
                            <div class="card-body">
                                @include('forms.product_expire_setting', [
                                    'route' => route('product_expire_settings.update', $model->id),
                                    'method' => 'PUT',
                                ])
                            </div>
                        </div>

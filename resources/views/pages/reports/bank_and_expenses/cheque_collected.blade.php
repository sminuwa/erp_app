    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4>Cheque Collected Report</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('deposits.create') }}">Bank Deposit</a></li>
                            <li class="breadcrumb-item active">Cheque Collected</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <a href="{{ route('suppliers.payment.create') }}" class="btn btn-sm btn-secondary" style="margin-left: 2px;"><span
                    class="ion-social-usd-outline"> </span> Pay Supplier</a>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-8">
                        <form method="POST" class="form-inline">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <select
                                    ...
                                    name="bank_account_id" id="bank_account_id" required>
                                    <option value="">Select...</option>
                                    <option>All Banks</option>
                                    @foreach ($bank_accounts as $data)
                                        <option value="{{ $data->id }}">{{ $data->account_name }}-{{ $data->account_no }}
                                        </option>
                                    @endforeach
                                </select>
                            </div> --}}
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#generate').on("click", function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('ajax.cheque.collected.report') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        from_date: from_date,
                        to_date: to_date

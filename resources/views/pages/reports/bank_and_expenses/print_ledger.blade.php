                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align: center">
                            ...
                            <h5 style="text-align: center;">{{ strtoupper($bank_account->account_name) }} LEDGER LISTING BETWEEN
                    ...
                    <div class="row" style="line-height: 0.4">
                        <div class="col-12 table-responsive">
                            <table class="table table-bordered caption" id="example1" border="1" cellpadding="0"
                                ...
                                @foreach ($ledgers as $ledger)
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            ...
                                            $sum_dr += $ledger->dr;
                                            $dif = $sum_cr - $sum_dr;
                                            $balance = $ledger->where('id', '<=', $ledger->id)->where('bank_account_id',$bank_account->id)->sum('cr') - $ledger->where('id', '<=', $ledger->id)->where('bank_account_id',$bank_account->id)->sum('dr'); ?>
                                            @if ($dif < 0)
                                ...
                                <tr>
                                    <td colspan="7">
                                        <h5 style="text-align: center;">{{ strtoupper($bank_account->account_name) }} Closing

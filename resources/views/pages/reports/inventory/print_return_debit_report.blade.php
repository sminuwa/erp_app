...
<head>
    ...
    <title>List of return & Debit Report - {{ config('app.name', 'Inventory Management System') }}</title>
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align: center">
                            ...
                            <h5 style="text-align: center;">LIST OF RETURN & DEBIT
                                BETWEEN
                    ...
                    <div class="row" style="line-height: 0.4">
                        <div class="col-12 table-responsive">
                            <table class="display table table-bordered caption" id="example1" border="1"
                                cellpadding="0" cellspacing="0" data-ordering="true">
                                <thead>
                                    <tr>

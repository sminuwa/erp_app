<div class="row">
    <div class="offset-10">
        <a href="{{ route('ajax.relation_officer.report.print', [$from_date, $to_date, $company_id,$branch_id, $store_id, $category_id, $product_id, $staff_id]) }}"
...
<table class="display table table-bordered caption" id="example1" data-ordering="false">
    <caption style="caption-size:top">
        ...
        <h5 style="text-align: center;">{{ ucfirst($user->name ?? 'All ROs') }} <br />Relation Officer Sales
            From

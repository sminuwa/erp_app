        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-right">
                    <a href="{{ route('ajax.category.site.sales.report.print', [$from_date, $to_date, $company_id, is_array($branch_id) ? implode(',', $branch_id) : $branch_id, is_array($category_id1) ? implode(',', $category_id1) : $category_id1]) }}"

    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4>Most Sold Items By Quanity Report</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Most Sold Items</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <form method="POST" class="form-inline form-check-inline">
                    <div class="row">
                        ...
                        <div class="form-group  col-sm-6">
                            ...
                            <input type="number" name="number_limit" id="number_limit" class="form-control" placeholder="Enter the number of record to display" min="1" />
                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#generate').on("click", function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('ajax.load.most.sold.item.quantity.reports') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        from_date: from_date,
                        to_date: to_date,

...
<head>
    ...
    <title>Item Sold - {{ config('app.name', 'Inventory Management System') }}</title>
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align: center">
                            ...
                            <h5>
                                GROUP/PRODUCT NAME:
                                {{ $category_id == 'all' ? 'All Categoris' : \App\Models\Category::find($category_id)->name }}/{{ $product_id == 'all' ? 'All products' : \App\Models\Product::find($product_id)->name }}
                            </h5>
                        </div>
                        <!-- /.col -->
                    </div>

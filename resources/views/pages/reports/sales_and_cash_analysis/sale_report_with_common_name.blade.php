    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form method="POST" class="form-inline form-check-inline">
                    ...
                    <div class="row">
                        <div class="form-group  col-sm-4">
                            ...
                            &nbsp;&nbsp;All Customers &nbsp;&nbsp; &nbsp;&nbsp;
                            <input type="radio" name="credit_walkedin" value="Credit" class="form-control" />
                            &nbsp;&nbsp;Credit Customer &nbsp;&nbsp; &nbsp;&nbsp;
                            <input type="radio" name="credit_walkedin" value="Walked In" class="form-control" />
                            &nbsp;&nbsp;Walked In
                        </div>
                        <div class="form-group  col-sm-2">
                            &nbsp;&nbsp;
                ...
                <div class="row">
                    <div class="col-sm-6 table-responsive" id="load">

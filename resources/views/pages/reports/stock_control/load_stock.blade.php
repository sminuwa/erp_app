<div class="row">
    <div class="offset-10">
        <a href="{{ route('ajax.current.stock.report.print', [$branch_id, $store_id, is_array($category_id) ? implode(',', $category_id) : $category_id, $product_id]) }}"
    ...
    <table class="display table table-bordered caption" id="example1">
        ...
        <thead>
            <tr>
                ...
                <th style="width: 50%;text-align:right" colspan="6">Pricessed By {{ auth()->user()->name }}</th>
            </tr>
            <tr>
                <th>BRANCH</th>
                <th>STORE</th>

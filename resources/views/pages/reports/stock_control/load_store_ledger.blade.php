<div class="store-ledger-results">
    ...
    <div class="table-responsive">
        <table class="display table table-bordered table-hover table-striped table-sm mb-0" id="example1">
            ...
            <tr>
                <th colspan="6" class="border-0 py-2 text-muted small">
            ...
            <tr>
                ...
                <th class="bg-light">Date of receipt</th>
                <th class="bg-light">Last date issued</th>
            ...
            @foreach ($stores as $store)
                ...
                <tr>
                    ...
                    <td>{{ $store->last_issue_date ? \Carbon\Carbon::parse($store->last_issue_date)->format('d/m/Y') : '—' }}</td>

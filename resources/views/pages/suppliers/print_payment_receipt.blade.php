                    ...
                    <div class="receipt-header">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="receipt-left">
                                <img src="{{ asset('assets/backend/img/logo'.App\Models\User::userBranchAction().".png") }}"
                                    style="width:71px;height:71px;border-radius: 43px;" alt="Novomed logo"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                            <div class="receipt-right">
                                <h5>MUABAS</h5>
                                <p>{{ $setting->phone }}<i class="fa fa-phone"></i></p>
                                <p>{{ $setting->email }}<i class="fa fa-envelope-o"></i></p>
                                <p>{{ $setting->address }} <i class="fa fa-location-arrow"></i></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <p>
                                        <strong><i
                                                class="fa fa-inr"></i>{{ number_format($payment->dr, 2) }}</strong>
                                    </p>
                                    <p>
                                        @php
                    ...
                    <div class="receipt-header receipt-header-mid receipt-footer">
                        <div class="col-xs-10 col-sm-10 col-md-10 text-left">
                            <div class="receipt-right">
                                ...
                                <p><b>Debt Collected By :</b> {{ $payment->user->name }}</p>

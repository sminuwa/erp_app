                                ...
                                <table id="example1"
                                    ...
                                    @foreach ($reports as $report)
                                        <tr>
                                            ...
                                            <td>
                                                {{
                                                    $report->payer()->code ? $report->payer()->code.' - '.$report->payer()->name : ($report->payer()->number.' - '.$report->payer()->description)
                                                }}
                                            </td>
                                            <td align="right">{{ number_format($report->credit, 2, '.', ',') }}</td>
                                            <td align="right">{{ number_format($report->debit, 2, '.', ',') }}</td>
                                            <td>{{ $report->description }}</td>
                                            <td>{{ optional($report->createdBy)->name }}</td>
